...
namespace NLog.Visar.WinForms.Targets
{
    ...
    public sealed class MessageBoxTarget : TargetWithLayout
    {
        ...
        private void ShowMessage(LogEventInfo logEvent, string message = null)
        {
            ...
            MessageBox.Show(message ?? this.Layout.Render(logEvent), caption ?? this.Caption.Render(logEvent),
                MessageBoxButton.OK, messageBoxIcon?? ToMessageBoxImage(logEvent.Level));
        }
